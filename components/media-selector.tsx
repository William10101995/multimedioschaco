...
export default function MediaSelector({ availableMedia, onSelectMedia, isFullscreen = false }: MediaSelectorProps) {
  // Group media by type
  ...
  return (
    <div className="h-full flex flex-col items-center justify-center p-2 bg-slate-50 dark:bg-slate-800/50">
      ...
      <Tabs defaultValue="quick" className="w-full">
        ...
        <TabsContent value="all" className="mt-0 max-h-[120px] overflow-y-auto pr-1">
